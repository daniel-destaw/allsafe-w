      ...
      <div className="max-w-2xl text-center mx-auto py-24 px-5">
        ...
        <div className="flex justify-center flex-col md:flex-row mt-5 gap-3">
          <span className="bg-violet-100 flex gap-5 items-center justify-between py-3 px-5 rounded-full">
            <code className="text-violet-900 text-left whitespace-nowrap overflow-hidden overflow-ellipsis">apt-get install allsafe-auth</code>
          ...
          <a className="bg-violet-500 justify-center inline-flex items-center gap-2 rounded-full py-3 px-6 text-white font-medium hover:bg-violet-700" href="/docs">
